...
|:---|:---:|:---|
| [MatthewPaver](https://github.com/MatthewPaver/MatthewPaver) | 2026-05-22 | Portfolio: AI products, data systems, ML, and analytics — every project has a preview,… |
| [ai-workflow-evaluator](https://github.com/MatthewPaver/ai-workflow-evaluator) | 2026-05-22 | Runnable quality gate for LLM workflow outputs: accuracy, grounding, hallucination risk… |
| [marketing-ml-lakehouse](https://github.com/MatthewPaver/marketing-ml-lakehouse) | 2026-05-22 | Local DuckDB, XGBoost, and Streamlit analytics pipeline for marketing performance data. |
