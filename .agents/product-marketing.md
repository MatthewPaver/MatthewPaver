...
**Target companies:** Teams hiring or collaborating around automation, AI workflow, data products, analytics, and operational tooling.
...
- Open live products and app-style previews.
- Compare project categories and technical depth.
- Find proof points for automation, AI workflow, and data systems.
...
**What it costs them:** Reviewers spend more time figuring out the shape of the work and may miss the strongest projects.

**Emotional tension:** The portfolio needs to look polished without sounding inflated.

## Competitive Landscape

**Direct:** Other GitHub profile READMEs and developer portfolios.

**Secondary:** Personal websites, Notion portfolios, LinkedIn featured sections.

**Indirect:** A plain CV or pinned repositories only.
...
**How we do it differently:** The portfolio explains projects through the job they do, not only the technologies used.

**Why that's better:** A reviewer can tell what each project solves and what proof exists before opening the repo.

**Why people choose this route:** It is faster to scan than a standard profile and more credible than broad claims.

## Objections

| Objection | Response |
|---|---|
| Is this too polished for GitHub? | The README stays lean; the store does the visual work. |
| Are private projects too vague? | Case studies explain architecture and decisions without exposing private data. |
| Is this just AI-generated copy? | Keep wording direct, specific, and tied to repo evidence. |
...
Direct, practical, technical, calm, and specific. Prefer plain English over hype. Use short proof points and concrete project outcomes.
